      ...
      >
        ...
        <div className="sm:w-[52%] bg-gradient-to-br from-[#03181c] to-[#041e24] p-6 sm:p-10 relative overflow-hidden">
          ...
          >
            ...
            <span className="text-xl font-bold text-[#e8f8fa] tracking-tight" style={{ fontFamily:"'Syne',sans-serif" }}>DrishKD</span>
          </motion.div>
        ...
        >
          ...
          <div className="relative z-10 w-full max-w-[280px] sm:max-w-[260px] text-center mx-auto">
            ...
            <motion.div
              ...
              className="w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center overflow-hidden rounded-2xl mx-auto mb-5 sm:mb-6"
            >
              <img src="/logo.png" alt="DrishKD Logo" className="w-full h-full object-cover transform scale-125" />
            </motion.div>
