       ...
       {userData ? (
        ...
        <div className="w-full max-w-md mx-auto text-left space-y-4 mb-8">
          ...
          <div>
            ...
            <CodeBlock code={`npm i kd-lib-krishna`} lang="bash" />
          </div>
          ...
          <div>
            ...
            <CodeBlock code={`import { ComponentName } from "kd-lib-krishna";`} lang="jsx" />
          </div>
...
function DetailPanel({ component, onBack }) {
  ...
  const importCode = `import { ${component.name} } from "kd-lib-krishna";`;
  const usageCode = `import { ${component.name} } from "kd-lib-krishna";\n\nexport default function App() {\n  return (\n    <div>\n      <${component.name}${
  ...
  return (
    ...
    >
      ...
      <nav className="sticky top-0 z-40 flex items-center justify-between px-4 sm:px-8 py-3.5 sm:py-4 border-b border-white/[0.05] bg-[#030b0d]/90 backdrop-blur-md shrink-0">
        ...
        >
          <div className="w-7 h-7 sm:w-8 sm:h-8 flex flex-shrink-0 items-center justify-center overflow-hidden rounded-xl">
            <img src="/logo.png" alt="DrishKD Logo" className="w-full h-full object-cover transform scale-125" />
          </div>
          <span
