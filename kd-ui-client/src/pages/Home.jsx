...
const features = [
  {
    ...
    text: "Install DrishKD and use ready-made, production-grade components instantly.",
  },
  {
    icon: HiSparkles,
  ...
  },
  {
    icon: TbBrandNpm,
    title: "NPM Library",
    text: "Import DrishKD components with a simple npm install command.",
  },
  {
    icon: TbPlayerPlay,
    title: "Live Preview",
...
const steps = [
  {
    ...
    text: "npm install kd-lib-krishna to access all prebuilt UI components.",
  },
  {
    n: "02",
...
export default function Home() {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("npm i kd-lib-krishna");
    setCopied(true);
  ...
  return (
    ...
    >
      ...
      <nav className="sticky top-0 z-40 flex items-center justify-between px-4 sm:px-8 lg:px-10 py-4 border-b border-white/[0.05] bg-[#030b0d]/85 backdrop-blur-md">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-[#3be8ff] to-[#0ab5d4] flex items-center justify-center shadow-[0_0_14px_rgba(59,232,255,0.4)]">
            <div className="w-9 h-9 flex flex-shrink-0 items-center justify-center overflow-hidden rounded-xl">
              <img
                src="/logo.png"
                alt="DrishKD Logo"
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            <a
              onClick={() => navigate("/component")}
              className="text-sm text-white/60 hover:text-white transition-colors py-1 cursor-pointer"
            >
              Components
            </a>
            {userData ? (
      ...
      <section className="relative max-w-5xl mx-auto px-4 sm:px-6 pt-16 sm:pt-24 pb-12 sm:pb-20 text-center">
        ...
        >
          Use prebuilt DrishKD components or generate custom ones with AI. Copy
        ...
        >
          <div className="flex items-center gap-2 sm:gap-3 bg-white/[0.04] border border-white/10 rounded-xl px-4 sm:px-5 py-3 text-xs sm:text-sm font-mono w-full max-w-xs sm:max-w-fit">
            ...
            <span className="text-white/80 truncate">npm i kd-lib-krishna</span>
            <button
              onClick={handleCopy}
        ...
        >
          ...
          <div className="font-mono text-[11px] sm:text-[12.5px] leading-6 space-y-0.5 min-w-[280px]">
            <p>
              ...
              <span className="text-[#aaff80]/70">'kd-lib-krishna'</span>
      ...
      <footer className="border-t border-white/[0.05] py-8 sm:py-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-sm font-semibold text-white/60">DrishKD</span>
          </div>
          <div className="flex flex-wrap justify-center gap-4 sm:gap-5 text-xs text-white/30">
            ...
            <a className="hover:text-white/60 transition-colors cursor-pointer">
              admin@drishkd.com
            </a>
          </div>
          <p className="text-xs text-white/25 order-last sm:order-none">
            © {new Date().getFullYear()} DrishKD. All rights reserved.
          </p>
        </div>
      </footer>
