...
var ProductCard = ({
  ...
  return /* @__PURE__ */ import_react26.default.createElement(
    ...
    /* @__PURE__ */ import_react26.default.createElement("div", { style: { position: "relative", width: "100%", height: "200px", overflow: "hidden" } }, /* @__PURE__ */ import_react26.default.createElement("img", { src: image, alt: title, style: { width: "100%", height: "100%", objectFit: "cover", transform: hovered ? "scale(1.05)" : "scale(1)", transition: "transform 0.4s ease" } }), /* @__PURE__ */ import_react26.default.createElement("div", { style: { position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(0,0,0,0.5) 0%, transparent 60%)" } })),
    /* @__PURE__ */ import_react26.default.createElement("div", { style: { padding: "18px" } }, /* @__PURE__ */ import_react26.default.createElement("h3", { style: { fontSize: "15px", fontWeight: "700", color: "#fff", margin: "0 0 8px", lineHeight: 1.4 } }, title), /* @__PURE__ */ import_react26.default.createElement("p", { style: { fontSize: "13px", color: "rgba(255,255,255,0.45)", lineHeight: 1.65, margin: "0 0 8px" } }, description), /* @__PURE__ */ import_react26.default.createElement("div", { style: { display: "flex", alignItems: "center", gap: "4px", marginBottom: "12px" } }, /* @__PURE__ */ import_react26.default.createElement("div", { style: { display: "flex", alignItems: "center" } }, Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ import_react26.default.createElement("svg", { key: i, width: "16", height: "16", viewBox: "0 0 24 24", fill: i < Math.round(rating) ? "#ffd700" : "rgba(255,255,255,0.1)", stroke: i < Math.round(rating) ? "#ffd700" : "rgba(255,255,255,0.1)", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ import_react26.default.createElement("polygon", { points: "12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.01 12 17.77 5.82 21.01 7 14.14 2 9.27 8.91 8.26 12 2" })))), /* @__PURE__ */ import_react26.default.createElement("span", { style: { fontSize: "12px", color: "rgba(255,255,255,0.45)" } }, "(", reviews, ")")), /* @__PURE__ */ import_react26.default.createElement("div", { style: { fontSize: "20px", fontWeight: "800", color: "#fff", marginBottom: "18px" } }, currency, price), /* @__PURE__ */ import_react26.default.createElement("div", { style: { display: "flex", gap: "8px" } }, /* @__PURE__ */ import_react26.default.createElement(
      "button",
      {
        onClick: onAddToCart,
        style: {
...
var SidePanel = ({
  ...
  return /* @__PURE__ */ import_react27.default.createElement("div", { style: { position: "fixed", top: 0, [position]: 0, height: "100vh", width: isOpen ? width : 0, zIndex: 1e3, transition: "width 0.3s ease" } }, /* @__PURE__ */ import_react27.default.createElement("div", { style: { position: "absolute", top: 0, [position]: 0, height: "100%", width, background: bg, borderLeft: position === "right" ? "1px solid rgba(255,255,255,0.08)" : "none", borderRight: position === "left" ? "1px solid rgba(255,255,255,0.08)" : "none", boxShadow: "0 0 40px rgba(0,0,0,0.5)" } }, /* @__PURE__ */ import_react27.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "20px", borderBottom: "1px solid rgba(255,255,255,0.08)" } }, /* @__PURE__ */ import_react27.default.createElement("div", { style: { fontSize: "18px", fontWeight: "700", color: "#fff" } }, title), /* @__PURE__ */ import_react27.default.createElement("button", { onClick: onClose, style: { background: "transparent", border: "none", cursor: "pointer", padding: "8px", borderRadius: "8px", transition: "background 0.2s" } }, /* @__PURE__ */ import_react27.default.createElement("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "rgba(255,255,255,0.5)", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", style: { transition: "stroke 0.2s" } }, /* @__PURE__ */ import_react27.default.createElement("line", { x1: "18", y1: "6", x2: "6", y2: "18" }), /* @__PURE__ */ import_react27.default.createElement("line", { x1: "6", y1: "6", x2: "18", y2: "18" })))), /* @__PURE__ */ import_react27.default.createElement("div", { style: { padding: "20px", overflowY: "auto", height: "calc(100% - 60px)" } }, children)));
};
