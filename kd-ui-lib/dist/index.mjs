...
var ProductCard = ({
  ...
  return /* @__PURE__ */ React26.createElement(
    ...
    /* @__PURE__ */ React26.createElement("div", { style: { position: "relative", width: "100%", height: "200px", overflow: "hidden" } }, /* @__PURE__ */ React26.createElement("img", { src: image, alt: title, style: { width: "100%", height: "100%", objectFit: "cover", transform: hovered ? "scale(1.05)" : "scale(1)", transition: "transform 0.4s ease" } }), /* @__PURE__ */ React26.createElement("div", { style: { position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(0,0,0,0.5) 0%, transparent 60%)" } })),
    /* @__PURE__ */ React26.createElement("div", { style: { padding: "18px" } }, /* @__PURE__ */ React26.createElement("h3", { style: { fontSize: "15px", fontWeight: "700", color: "#fff", margin: "0 0 8px", lineHeight: 1.4 } }, title), /* @__PURE__ */ React26.createElement("p", { style: { fontSize: "13px", color: "rgba(255,255,255,0.45)", lineHeight: 1.65, margin: "0 0 8px" } }, description), /* @__PURE__ */ React26.createElement("div", { style: { display: "flex", alignItems: "center", gap: "4px", marginBottom: "12px" } }, /* @__PURE__ */ React26.createElement("div", { style: { display: "flex", alignItems: "center" } }, Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ React26.createElement("svg", { key: i, width: "16", height: "16", viewBox: "0 0 24 24", fill: i < Math.round(rating) ? "#ffd700" : "rgba(255,255,255,0.1)", stroke: i < Math.round(rating) ? "#ffd700" : "rgba(255,255,255,0.1)", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React26.createElement("polygon", { points: "12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.01 12 17.77 5.82 21.01 7 14.14 2 9.27 8.91 8.26 12 2" })))), /* @__PURE__ */ React26.createElement("span", { style: { fontSize: "12px", color: "rgba(255,255,255,0.45)" } }, "(", reviews, ")")), /* @__PURE__ */ React26.createElement("div", { style: { fontSize: "20px", fontWeight: "800", color: "#fff", marginBottom: "18px" } }, currency, price), /* @__PURE__ */ React26.createElement("div", { style: { display: "flex", gap: "8px" } }, /* @__PURE__ */ React26.createElement(
      "button",
      {
        onClick: onAddToCart,
        style: {
