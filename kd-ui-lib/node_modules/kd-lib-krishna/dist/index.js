...
var Graph = ({
  ...
  const points = data.map((v, i) => padding + i * xStep + "," + (height - padding - v * yStep));
  return /* @__PURE__ */ import_react28.default.createElement("div", { style: { position: "relative", width, height, borderRadius: "20px", overflow: "hidden", background: bg, boxShadow: "0 10px 40px rgba(0,0,0,0.5)", border: "1px solid " + alpha(accent, 0.25) } }, /* @__PURE__ */ import_react28.default.createElement("svg", { width, height }, Array.from({ length: 6 }).map((_, i) => /* @__PURE__ */ import_react28.default.createElement("line", { key: i, x1: padding, x2: width - padding, y1: padding + i * ((height - padding * 2) / 5), y2: padding + i * ((height - padding * 2) / 5), stroke: gridColor, strokeWidth: "1" })), /* @__PURE__ */ import_react28.default.createElement("polyline", { points: points.join(" "), fill: "none", stroke: accent, strokeWidth, strokeLinecap: "round", strokeLinejoin: "round" }), points.map((p, i) => /* @__PURE__ */ import_react28.default.createElement("circle", { key: i, cx: p.split(",")[0], cy: p.split(",")[1], r: dotSize, fill: alpha(accent, 0.95), stroke: bg, strokeWidth: "2" })), data.map((v, i) => /* @__PURE__ */ import_react28.default.createElement("text", { key: i, x: padding + i * xStep, y: height - padding + 20, fill: labelColor, fontSize: "10px", textAnchor: "middle", fontFamily: "system-ui,sans-serif" }, v))));
};
